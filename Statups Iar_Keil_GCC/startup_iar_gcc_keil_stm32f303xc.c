...
//------------------------------
  ...
  #define __STACK_TOP &__reserved_for_stack_end__
  extern void* __reserved_for_stack_end__;
  void SystemInit();
  void __libc_init_array();
  int main() __attribute__((__noreturn__));
  ...
  void __attribute__((naked, noreturn)) Reset_Handler()
  {
      ...
      __set_MSP((uint32_t)__STACK_TOP);
    #endif
...
static uint8_t _heap[1024]  __attribute__((used, section(".heap"), aligned(8)));
